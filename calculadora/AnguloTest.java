...
public class AnguloTest
{
    ...
    public void deberiaDividir(){
        assertEquals (1, a0.divida(a0));
        assertEquals (0.75, a45.divida(a60));
    }
    ...
    @Test
    public void hacerTrue(){
        assertTrue(a0 == a0);
    }

    
    @Test
    public void hacerError(){
        assertEquals(a0,Angulo.MAXERROR);
        assertEquals(a30,"1");
    }
    ...
    public void deberiaPoderExpresarUnAnguloComoCadena(){       
        if (a0.toString().getClass().getName() == "java.lang.String"){
            double num = Double.parseDouble(a0.toString());
            assertTrue(num == a0.grados() || num == a0.gradianes() || num == a0.radianes());
        }
    }
